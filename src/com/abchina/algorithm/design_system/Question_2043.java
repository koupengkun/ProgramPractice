...
/**
 * 2043. 简易银行系统
 * 你的任务是为一个很受欢迎的银行设计一款程序，以自动化执行所有传入的交易（转账，存款和取款）。银行共有 n 个账户，编号从 1 到 n 。每个账号的初始余额
 * 存储在一个下标从 0 开始的整数数组 balance 中，其中第 (i + 1) 个账户的初始余额是 balance[i] 。
 ...
 * 用数组做数据结构，进行数组操作
 */
public class Question_2043 {
    long[] accounts;
    public Question_2043(long[] balance) {
